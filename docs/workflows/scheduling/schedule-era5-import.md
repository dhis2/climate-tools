...
For a complete example of an implementation that imports ERA5-Land data on a schedule, with additional convenience functionality, see the [dhis2-era5land-simple](https://github.com/mortenoh/dhis2-era5land-simple) repository. 
